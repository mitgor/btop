...
namespace Mem {
	...
	auto collect(bool no_update) -> mem_info & {
		...
		mem.stats[std::to_underlying(MemField::used)] = memActive + memWired;
		mem.stats[std::to_underlying(MemField::available)] = Shared::totalMem - (memActive + memWired);
		mem.stats[std::to_underlying(MemField::cached)] = memCached;
		mem.stats[std::to_underlying(MemField::free)] = memFree;

		if (show_swap) {
			mem.stats[std::to_underlying(MemField::swap_total)] = uvmexp.swpages * Shared::pageSize;
			mem.stats[std::to_underlying(MemField::swap_used)] = uvmexp.swpginuse * Shared::pageSize;
			mem.stats[std::to_underlying(MemField::swap_free)] = (uvmexp.swpages - uvmexp.swpginuse) * Shared::pageSize;
		}
