...
namespace Mem {
	...
	auto collect(bool no_update) -> mem_info & {
		...
		mem.stats[std::to_underlying(MemField::used)] = memWire + memActive;
		...
		len = sizeof(freeMem);
   		...
   		mem.stats[std::to_underlying(MemField::free)] = freeMem;
		...
		if (show_swap) {
			...
			mem.stats[std::to_underlying(MemField::swap_total)] = totalSwap * Shared::pageSize;
			mem.stats[std::to_underlying(MemField::swap_used)] = usedSwap * Shared::pageSize;
		}
